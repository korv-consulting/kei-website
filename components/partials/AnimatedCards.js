        ...
        <>
            <center>
                <section className={styles.section}>
                    <h2>La solution complète de bout en bout</h2>
                </section>
            </center>
            <div className={styles.container}>
                ...
                <div className={styles.card}>
                    <h3>Tableau de bord detaillé</h3>
                ...
                <div className={styles.card}>
                    <h3>Generation des Templates</h3>
                ...
                <div className={styles.card}>
                    <h3 className="mb-2">Des rapports  Interactifs</h3>
                ...
                <div className={styles.card}>
                    <h3>Creation et suivi des Tâches</h3>
                    <svg width="300px" height="200px" viewBox="0 0 300 200" xmlns="http://www.w3.org/2000/svg" fill="#000000">
