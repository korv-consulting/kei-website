        ...
        <>
            <Navbar bg="white" expand="lg" className={`${styles.navbar}`}>
                <Container fluid>
                    ...
                    <Navbar.Toggle aria-controls="navbarScroll" className={styles.menu_icon}/>
                    <Navbar.Collapse id="navbarScroll">
                        ...
                        <Form className="d-flex">
                            <Button className={styles.login_btn} id="btn_login"  onClick={() => router.push('/signin')}>
                                Connexion
                            </Button>
                            <Button className={styles.signup_btn}  onClick={() => router.push('/signup')}>
                                Souscrire
                            </Button>
                        </Form>
                    </Navbar.Collapse>
