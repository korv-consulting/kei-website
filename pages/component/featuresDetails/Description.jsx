  ...
  return (
    <div>
      <div className="container">
        ...
        <div className="row d-flex justify-content-center mb-5" ref={el => featureRefs.current[0] = el}>
        ...
        <div className="row d-flex justify-content-center mb-5" ref={el => featureRefs.current[1] = el}>
        ...
        <div className="row d-flex justify-content-center mb-5" ref={el => featureRefs.current[2] = el}>
          <div className="col-md-6">
            <div className={styles.featureImageContainer}>
        ...
        <div className="row d-flex justify-content-center mb-5" ref={el => featureRefs.current[3] = el}>
          <div className="col-md-6 order-md-2">
            <div className={styles.featureImageContainer}>
